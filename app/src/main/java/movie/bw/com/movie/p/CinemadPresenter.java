 ...
 * 说明：
 */
public class CinemadPresenter extends BasePresenter {
    public CinemadPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.findAllCinemas((int) args[0], (int) args[1], (String) args[2]);
    }
}

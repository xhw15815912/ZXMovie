...
public class NowAdapter extends RecyclerView.Adapter<NowAdapter.ViewHolder> {
    ...
    public NowAdapter(FragmentActivity activity) {
    ...
    @NonNull
    @Override
    public NowAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = View.inflate(context, R.layout.hotmovie_item, null);

        return new NowAdapter.ViewHolder(inflate);
    }

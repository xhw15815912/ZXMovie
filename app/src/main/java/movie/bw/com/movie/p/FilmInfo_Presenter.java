 ...
 * 说明：
 */
public class FilmInfo_Presenter extends BasePresenter {
    public FilmInfo_Presenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.FilmInfo((int)args[0],(String)args[1],(int)args[2]);
    }
}
